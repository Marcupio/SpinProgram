...
#used to find AGR for a single gamma

def AGR(N,Nlegs,phiamt,gamma,c=np.sqrt(2),Nstates=30,Jcurr=0,J1=1,J2=1,ratio=[1,1], modex2='open', modey2='open'):
    ...
    def getH(phi):
        ...
        Hfull = H.nlegHeisenberg.blockH(N,S,Nlegs,c,Js=[J1,J2],gamma=[ratio1*gamma,ratio2*gamma],phi=[phi[0],phi[1]], modex1=modex2, modey1=modey2)
        return(sum(Hfull))
    ...
    end1= time.time()
    print('time for gamma= ', end1-start1)  
